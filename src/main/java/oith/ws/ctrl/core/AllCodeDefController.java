...
import oith.ws.dom.core.AllCodeDef;
...
import oith.ws.exception.AllCodeDefNotFoundException;
...
@Controller
@RequestMapping(value = "/allCodeDef")
public class AllCodeDefController extends oith.ws.ctrl.core._OithClientAuditController {

    protected static final String MODEL_ATTIRUTE = "allCodeDef";
    ...
    @Autowired
    private oith.ws.service.AllCodeDefService allCodeDefService;
    ...
    public String create(ModelMap model, Locale locale) {
        ...
        model.addAttribute(MODEL_ATTIRUTE, new AllCodeDef(client));
    ...
    public String save(
            @ModelAttribute(MODEL_ATTIRUTE) @Valid AllCodeDef currObject,
        ...
        AllCodeDef currObjectLocal = allCodeDefService.create(currObject);
    ...
    public String edit(@PathVariable("id") String id, ModelMap model, Locale locale) {
        ...
        try {
            AllCodeDef currObjectLocal = allCodeDefService.findById(id, client);
            model.addAttribute(MODEL_ATTIRUTE, currObjectLocal);
            allComboSetup(model, locale);
            return EDIT_FORM_VIEW;
        } catch (AllCodeDefNotFoundException ex) {
            return NOT_FOUND;
    ...
    public String update(
        ...
        try {
            ...
            return REDIRECT_TO_LOGIN;
        } catch (AllCodeDefNotFoundException | UserNotFoundException ex) {
            return NOT_FOUND;
        }

        try {
            //allCodeDef = allCodeDefService.update(currObject);
            AllCodeDef currObjectLocal = allCodeDefService.update(currObject, "auditor,domClass,mode,preFix,postFix,nextValue,codeLength,active");
    ...
    public String copied(
        ...
        AllCodeDef currObjectReal;
        try {
            currObjectReal = allCodeDefService.findById(id, client);
        ...
        try {
            AllCodeDef currObjectLocal = new AllCodeDef(client);
            MacUtils.copyProperties(currObjectLocal, currObject, currObjectReal, "auditor,domClass,mode,preFix,postFix,nextValue,codeLength,active");
            currObjectLocal = allCodeDefService.create(currObjectLocal);
    ...
    public String search(@ModelAttribute(SEARCH_CRITERIA) _SearchDTO searchCriteria, ModelMap model) {
        ...
        List<AllCodeDef> allCodeDefs;

        if (searchTerm != null && !searchTerm.trim().isEmpty()) {
            allCodeDefs = allCodeDefService.search(searchCriteria, client);
        } else {
            allCodeDefs = allCodeDefService.findAllByClient(searchCriteria, client);
        }
        model.addAttribute(MODEL_ATTRIBUTES, allCodeDefs);
    ...
    public String list(ModelMap model) {
        ...
        List<AllCodeDef> allCodeDefs = allCodeDefService.findAllByClient(searchCriteria, client);
    ...
    public String delete(@PathVariable("id") String id, RedirectAttributes attributes) {
        ...
        try {
            AllCodeDef deleted = allCodeDefService.delete(id, client);
            addFeedbackMessage(attributes, FEEDBACK_MESSAGE_KEY_DELETED, deleted.getId());
        } catch (AllCodeDefNotFoundException e) {

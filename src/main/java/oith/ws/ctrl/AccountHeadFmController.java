...
public class AccountHeadFmController extends _OithAuditController {
    ...
    public String save(@ModelAttribute(MODEL_ATTIRUTE) @Valid AccountHeadFm currObject, BindingResult bindingResult, RedirectAttributes attributes) {
    ...
    public String update(@ModelAttribute(MODEL_ATTIRUTE) @Valid AccountHeadFm currObject,
        ...
        try {
            AccountHeadFm accountHeadFm = accountHeadFmService.update(currObject);

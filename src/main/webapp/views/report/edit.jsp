...
<tiles:putAttribute name='body'>
    ...
    <div>
        <form:form action='${pageContext.request.contextPath}/report/edit/${report.id}' commandName='report' method='POST'>
            <form:hidden path='id'/>
            <jsp:include page='_form.jsp' />
            <div>
                <a href='${pageContext.request.contextPath}/report/show/${report.id}'><spring:message code='show.link.label'/></a>

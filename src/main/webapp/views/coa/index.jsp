...
<tiles:putAttribute name='body'>
    ...
    <form:form action='${pageContext.request.contextPath}/coa/index' commandName='searchCriteria' method='POST'>
        <table>
            <tr>
            ...
            <table class='table table-striped table-bordered table-hover table-condensed'>
                <thead>
                    <tr>
                        ...
                        <th><spring:message code='retainedEarningsAccount' text='Retained Earnings Account'/></th>
                        <th><spring:message code='lengthOfAccount' text='Length Of Account'/></th>

                    </tr>
                </thead>
                <tbody>
                    <c:forEach items='${coas}' var='coa'  varStatus='loopStatus'>
                        <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                            <td>
                                <a href="${pageContext.request.contextPath}/coa/show/${coa.id}" class="btn btn-info">
                                    <i class="glyphicon glyphicon-book"></i>
                                    <spring:message code="show.link.label"/>
                                </a>
                            </td>
                            <td><c:out value='${coa.auditor}'/></td>
                            <td><c:out value='${coa.code}'/></td>
                            <td><c:out value='${coa.title}'/></td>
                            <td><c:out value='${coa.retainedEarningsAccount}'/></td>
                            <td><c:out value='${coa.lengthOfAccount}'/></td>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/coa/delete/${coa.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" >

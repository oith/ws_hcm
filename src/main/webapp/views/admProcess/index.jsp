...
<tiles:putAttribute name='body'>
    ...
    <form:form action='${pageContext.request.contextPath}/admProcess/index' commandName='searchCriteria' method='POST'>
        <table>
            <tr>
            ...
            <table class='table table-striped table-bordered table-hover table-condensed'>
                <thead>
                    <tr>
                        ...
                        <th><spring:message code='admProcessDetails' text='Adm Process Details'/></th>
                ...
                <tbody>
                    <c:forEach items='${admProcesss}' var='admProcess'  varStatus='loopStatus'>
                        <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                            <td>
                                <a href="${pageContext.request.contextPath}/admProcess/show/${admProcess.id}" class="btn btn-info">
                            ...
                            <td><c:out value='${admProcess.admProcessDetails}'/></td>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/admProcess/delete/${admProcess.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" >

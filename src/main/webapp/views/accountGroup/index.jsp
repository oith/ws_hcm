...
<tiles:putAttribute name='body'>
    ...
    <form:form action='${pageContext.request.contextPath}/accountGroup/index' commandName='searchCriteria' method='POST'>
        <table>
            <tr>
    ...
    <c:if test='${accountGroups.size()!=0}'>
            ...
            <table class='table table-striped table-bordered table-hover table-condensed'>
                <thead>
                    <tr>
                        ...
                        <th><spring:message code='accountGroup' text='Account Group'/></th>
                        <th><spring:message code='title' text='Title'/></th>
                        <th><spring:message code='fromAccount' text='From Account'/></th>
                        <th><spring:message code='toAccount' text='To Account'/></th>
                ...
                <tbody>
                    <c:forEach items='${accountGroups}' var='accountGroup'  varStatus='loopStatus'>
                        <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                            <td>
                                <a href="${pageContext.request.contextPath}/accountGroup/show/${accountGroup.id}" class="btn btn-info">
                                    <i class="glyphicon glyphicon-book"></i>
                                    <spring:message code="show.link.label"/>
                                </a>
                            </td>
                            <td><c:out value='${accountGroup.coa}'/></td>
                            <td><c:out value='${accountGroup.accountGroup}'/></td>
                            <td><c:out value='${accountGroup.title}'/></td>
                            <td><c:out value='${accountGroup.fromAccount}'/></td>
                            <td><c:out value='${accountGroup.toAccount}'/></td>
                            <td>
                                <c:choose >
                            ...
                            <td><c:out value='${accountGroup.slNo}'/></td>
                            <td><c:out value='${accountGroup.description}'/></td>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/accountGroup/delete/${accountGroup.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" >

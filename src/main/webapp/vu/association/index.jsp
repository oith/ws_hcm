...
<tiles:putAttribute name='body'>
    ...
    <form:form action='${pageContext.request.contextPath}/association/index' commandName='searchCriteria' method='POST'>
        <table>
            <tr>
    ...
    <c:if test='${associations.size()!=0}'>
        ...
        <div class='table-responsive'>
            <table class='table table-striped table-bordered table-hover table-condensed'>
                ...
                <tbody>
                    <c:forEach items='${associations}' var='association'  varStatus='loopStatus'>
                        <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                            <td>
                                <a href="${pageContext.request.contextPath}/association/show/${association.id}" class="btn btn-info">
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/association/delete/${association.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" >

...
<tiles:putAttribute name='body'>
    ...
    <form:form action='${pageContext.request.contextPath}/personnelSubarea/index' commandName='searchCriteria' method='POST'>
        <table>
            <tr>
    ...
    <c:if test='${personnelSubareas.size()!=0}'>
        ...
        <div class='table-responsive'>
            <table class='table table-striped table-bordered table-hover table-condensed'>
                ...
                <tbody>
                    <c:forEach items='${personnelSubareas}' var='personnelSubarea'  varStatus='loopStatus'>
                        <tr class='${loopStatus.index % 2 == 0 ? 'odd' : 'even'}'>
                            ...
                            <td><c:out value='${personnelSubarea.code}'/></td>
                            <td><c:out value='${personnelSubarea.name}'/></td>
                            <td><c:out value='${personnelSubarea.personnelArea}'/></td>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/personnelSubarea/delete/${personnelSubarea.id}" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" >
    ...
    <c:if test='${empty personnelSubareas}'>
        <p>

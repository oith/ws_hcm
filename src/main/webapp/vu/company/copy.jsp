...
<tiles:putAttribute name='body'>
    ...
    <div>
        <form:form action='${pageContext.request.contextPath}/company/copy/${company.id}' commandName='company' method='POST'>
            <form:hidden path='id'/>
            <jsp:include page='_form.jsp' />
            <div>
                <a href='${pageContext.request.contextPath}/company/show/${company.id}'><spring:message code='show.link.label'/></a>

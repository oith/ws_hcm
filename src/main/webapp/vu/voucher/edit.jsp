...
<tiles:putAttribute name="body">
    ...
    <div>
        <form:form action="${pageContext.request.contextPath}/voucher/edit/${voucher.id}" commandName="voucher" method="POST">
            <form:hidden path="id"/>
            <jsp:include page="_form.jsp" />
            <div>
                <a href="${pageContext.request.contextPath}/voucher/show/${voucher.id}"><spring:message code="show.link.label"/></a>

                ...
                <form:form action="${pageContext.request.contextPath}/report/reportDetails/edit/${report.id}" commandName="reportDetails" method="POST" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-xs-6">
                            ...
                            <input type="text" name="isActive" id="reportDetails_isActive" class="form-control" value="" >
                        </div>
                        <div class="col-xs-6">
                            <spring:message code="isMandatory" text="Is Mandatory"/>
                            <input type="text" name="isMandatory" id="reportDetails_isMandatory" class="form-control" value="" >
                        </div>
                        <div class="col-xs-6">
...
<script type="text/javascript">
    ...
    $(document).on("click", "tr", function () {
        ...
        $("#reportDetails_isActive").val($("td:eq(5)", this).text());
        $("#reportDetails_isMandatory").val($("td:eq(6)", this).text());
    ...
    $(document).on("click", "#reportDetails_create", function () {
        ...
        $("#reportDetails_isActive").val("");
        $("#reportDetails_isMandatory").val("");

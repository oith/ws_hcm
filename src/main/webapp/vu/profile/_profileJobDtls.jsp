                ...
                <form:form action="${pageContext.request.contextPath}/profile/profileJobDtl/edit" commandName="profileJobDtl" method="POST" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-xs-6" >
                            ...
                            <input type="date" name="fromDate" id="datepicker_fromDate" class="form-control" value="" placeholder="DD/MM/YYYY">
                        </div>

                        <div class="col-xs-6">
                            <spring:message code="toDate" text="To Date"/>
                            <input type="date" name="toDate" id="datepicker_toDate" class="form-control" placeholder="DD/MM/YYYY">
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        //$(".not_show").hide();
//alert("hh")
        $("#datepicker_fromDate").datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true, yearRange: '1950:2050'});
        $("#datepicker_toDate").datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true, yearRange: '1950:2050'});
    });

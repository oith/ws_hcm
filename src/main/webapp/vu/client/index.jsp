...
<tiles:putAttribute name="body">
    ...
    <form:form action="${pageContext.request.contextPath}/client/index" commandName="searchCriteria" method="POST">
    ...
    <c:if test="${clients.size()!=0}">
                ...
                <tbody>
                    <c:forEach items="${clients}" var="client"  varStatus="loopStatus">
                        ...
                        <tr class="${loopStatus.index % 2 == 0 ? 'odd' : 'even'}">
                            ...
                            <td><a href="${pageContext.request.contextPath}/client/edit/<c:out value="${client.id}"/>"><spring:message code="edit.link.label"/></a></td>
                            <td><a href="${pageContext.request.contextPath}/client/delete/<c:out value="${client.id}"/>" onclick="return confirm('Are you sure to delete?');" ><spring:message code="delete.link.label"/></a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
        ...
        <!--<div class="row-fluid">-->
        <!--    <div>
            <util:pagination thispage="${clients}"></util:pagination>
        </div>-->
    </c:if>

...
<tiles:putAttribute name="body">
    ...
    <div>
        <form:form action="${pageContext.request.contextPath}/menu/edit/${menu.id}" commandName="menu" method="POST">
            <form:hidden path="id"/>
            <jsp:include page="_form.jsp" />
            <div>
                <a href="${pageContext.request.contextPath}/menu/show/${menu.id}"><spring:message code="show.link.label"/></a>

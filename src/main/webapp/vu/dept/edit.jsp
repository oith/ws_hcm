...
<tiles:putAttribute name="body">
    ...
    <div>
        <form:form action="${pageContext.request.contextPath}/dept/edit/${dept.id}" enctype="multipart/form-data" commandName="dept" method="POST">
        <jsp:include page="_form.jsp" />
        <div>
            <a href="${pageContext.request.contextPath}/dept/show/<c:out value="${dept.id}"/>"><spring:message code="show.link.label"/></a>

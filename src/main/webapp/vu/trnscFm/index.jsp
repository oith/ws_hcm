...
<tiles:putAttribute name="body">
    ...
    <form:form action="${pageContext.request.contextPath}/trnscFm/index" commandName="searchCriteria" method="POST">
    ...
    <c:if test="${trnscFms.size()!=0}">
        <div style="margin: auto; overflow-x: scroll; padding-top: 5px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="style-table">
                ...
                <tbody>
                    <c:forEach items="${trnscFms}" var="trnscFm"  varStatus="loopStatus">

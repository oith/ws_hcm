...
<tiles:putAttribute name="body">
    ...
    <div>
        <form:form action="${pageContext.request.contextPath}/trnscFm/edit/${trnscFm.id}" enctype="multipart/form-data" commandName="trnscFm" method="POST">
        <jsp:include page="_form.jsp"/>
        <div>
            <a href="${pageContext.request.contextPath}/trnscFm/show/<c:out value="${trnscFm.id}"/>"><spring:message code="show.link.label"/></a>

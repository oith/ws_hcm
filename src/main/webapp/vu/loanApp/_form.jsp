...
<script type="text/javascript">
    $(document).ready(function () {
        $("#datepicker_sanctionDate").datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true, yearRange: '1950:2050'});
        $("#datepicker_appDate").datepicker({dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true, yearRange: '1950:2050'});
    });
</script>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="form-group">
            <div class="col-xs-6">
                <form:input path="emp.id" class="form-control" type="text" required="true"  size="6" maxlength="6"/>
            </div>
            <div class="col-xs-6">
                <form:input path="emp.profile.user.fullName" class="form-control" type="text" disabled="true"  size="30" maxlength="30"/> 
            </div> 
        </div>

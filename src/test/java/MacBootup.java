...
public class MacBootup {
    ...
    public void data() {
        ...
        profile1.setUser(null);
        profile1.setInsertByUser(null);
        profile1.setUpdateByUser(null);
        profile1.setClient(null);
